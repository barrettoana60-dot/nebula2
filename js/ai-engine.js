...
const NebulaAI = (() => {
    ...
    async function chatWithAI(messages) {
        ...
        // Detailed logging for failures to help diagnose missing API key or server errors
        if (!apiResult.ok) {
            console.warn('[NebulaAI] /api/chat failed:', apiResult.status, apiResult.bodyText || apiResult.error || apiResult.data || 'no-body');
        }
